...
public class PropertiesOperate {  
    ...
    public static String readData(String filePath, String key) {  
        //获取绝对路径  
        filePath = PropertiesOperate.class.getResource("/" + filePath).toString();  
        //截掉路径的”file:“前缀  
    ...
    public static void main(String[] args) {  
        System.out.println(PropertiesOperate.readData("com/xiewanzhi/property/config.properties", "port"));  
