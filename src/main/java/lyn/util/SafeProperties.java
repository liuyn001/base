...
/**
 * 
 * @ClassName: SafeProperties (properties的子类)
 * @Description: TODO 在读取properties文件的时候把注释和顺序格式都记录下来,操作时候也把添加顺序记录了,
 *               所以很好的解决了java.util.Properties类在输出的不足,同时它提供addComment()方法,
 *               可以添加注释,这样,经过处理的properties的可读性就能继续保持下来了.
 * @author lyn
 * @date 2017年5月31日 下午2:38:54
 */
